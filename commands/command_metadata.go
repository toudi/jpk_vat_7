...
func handleMetadataArgs(flagSet *flag.FlagSet) {
	flagSet.BoolVar(&saft.Metadata.UseTestGateway, "t", false, "użycie bramki testowej do generowania metadanych")
	flagSet.BoolVar(&saft.Metadata.AuthData.Enable, "a", false, "wygeneruj strukturę AuthData (alternatywa dla podpisu kwalifikowanego)")
	flagSet.Float64Var(&saft.Metadata.AuthData.Income, "a:i", 0.0, "użyj autoryzacji za pomocą kwoty przychodu")
